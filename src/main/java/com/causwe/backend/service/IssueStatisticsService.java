...
public interface IssueStatisticsService {
    ...
    Map<String, Long> getIssueStatusCounts(Long projectId);
    Map<String, Long> getIssuesPerDayAndStatusInWeek(Long projectId, String status);
    Map<String, Map<String, Long>> getIssuesPerFixer(Long projectId);
    ...
    Map<String, Map<String, Long>> getIssuesPerDayAndStatusInWeek(Long projectId);
}